...
- **AWAITING**: workflow completion (harness will notify) -> present the campaign -> user renders the Sociowash proof-reel + sends T1. THE TEST: does he actually send (vs the session-long GTM-avoidance).
