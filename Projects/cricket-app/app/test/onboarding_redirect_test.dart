...
import 'package:pitch_app/src/features/splash/presentation/splash_screen.dart';
...
void main() {
  ...
  testWidgets('a profile-read error shows a retry on splash, not create-profile '
      '(AUTH-4)', (tester) async {
    await tester.pumpWidget(
      ProviderScope(
        overrides: [
          authGateProvider.overrideWithValue(AuthGate.error),
          anonBootstrapProvider.overrideWith((ref) async {}),
        ],
        child: const PitchApp(),
      ),
