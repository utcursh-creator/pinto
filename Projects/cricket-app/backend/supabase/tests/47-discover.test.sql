...
select public.create_looking_for_post('player_seeking_team', 'loser_pays', 19.07, 72.89, 'near', null, null, null, null, null, null, 'Near') as _near \gset
select public.create_looking_for_post('player_seeking_team', 'loser_pays', 19.50, 72.87, 'far', null, null, null, null, null, null, 'Far') as _far \gset
select public.create_looking_for_post('player_seeking_team', 'loser_pays', 19.07, 72.89, 'old', null, null, null, null, null, null, 'Old', now() - interval '1 day') as _old \gset
